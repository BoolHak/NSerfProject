...
/// </summary>
public class HealthScoreManager(Awareness awareness, int maxMultiplier = 8)
{
    private readonly Awareness _awareness = awareness;
    private readonly int _maxMultiplier = maxMultiplier;
