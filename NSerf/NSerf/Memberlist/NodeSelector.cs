...
public class NodeSelector
{
    ...
    /// </summary>
    public static List<NodeState> SelectIndirectProbeNodes(
    ...
    /// </summary>
    public static NodeState? SelectNextProbeNode(List<NodeState> nodes, ref int probeIndex, string localNode)
    {
        if (nodes.Count == 0)
        {
            return null;
