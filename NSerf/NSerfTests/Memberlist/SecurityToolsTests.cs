...
public class SecurityToolsTests
{
    ...
    public void EncryptDecrypt_Version1_ShouldRoundTrip()
    {
        ...
        // Act - Encrypt
        var encrypted = SecurityTools.EncryptPayload(1, key, message, additionalData);
        
        // Act - Decrypt
        var decrypted = SecurityTools.DecryptPayload(new[] { key }, encrypted, additionalData);
    ...
    public void EncryptDecrypt_Version0WithPadding_ShouldRoundTrip()
    {
        ...
        // Act - Encrypt
        var encrypted = SecurityTools.EncryptPayload(0, key, message, additionalData);
    ...
    public void DecryptPayload_WithWrongAdditionalData_ShouldFail()
    {
        ...
        var encrypted = SecurityTools.EncryptPayload(1, key, message, correctData);
        
        // Act - Try to decrypt with wrong data
        Action act = () => SecurityTools.DecryptPayload(new[] { key }, encrypted, wrongData);
    ...
    public void DecryptPayload_WithMultipleKeys_ShouldTryAll()
    {
        ...
        // Encrypt with key3
        var encrypted = SecurityTools.EncryptPayload(1, key3, message, Array.Empty<byte>());
        
        // Act - Decrypt with multiple keys (key3 is last)
        var decrypted = SecurityTools.DecryptPayload(new[] { key1, key2, key3 }, encrypted, Array.Empty<byte>());
    ...
    public void EncryptedLength_Version1_ShouldCalculateCorrectly()
    {
        ...
        // Act
        var expectedLen = SecurityTools.EncryptedLength(1, messageLen);
    ...
    public void EncryptedLength_Version0WithPadding_ShouldCalculateCorrectly()
    {
        ...
        // Act
        var expectedLen = SecurityTools.EncryptedLength(0, messageLen);
    ...
    public void DecryptPayload_EmptyMessage_ShouldFail()
    {
        ...
        // Act
        Action act = () => SecurityTools.DecryptPayload(new[] { key }, emptyMessage, Array.Empty<byte>());
    ...
    public void DecryptPayload_TooShort_ShouldFail()
    {
        ...
        // Act
        Action act = () => SecurityTools.DecryptPayload(new[] { key }, tooShort, Array.Empty<byte>());
